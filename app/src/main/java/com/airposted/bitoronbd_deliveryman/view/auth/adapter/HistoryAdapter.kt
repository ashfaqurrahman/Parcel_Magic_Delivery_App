...
class HistoryAdapter(var context: Context, data: List<DataModel>) :
    RecyclerView.Adapter<HistoryAdapter.HomeViewHolder>() {
    private var data: List<DataModel> = ArrayList<DataModel>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        val theView: View = LayoutInflater.from(context).inflate(R.layout.my_delivery_history_list_item, parent, false)
