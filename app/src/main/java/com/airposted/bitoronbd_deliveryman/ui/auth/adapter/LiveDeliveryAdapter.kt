...
import com.airposted.bitoronbd_deliveryman.ui.main.LiveParcelDetailsFragment
...
class LiveDeliveryAdapter(var context: Context, data: List<DataModel>) :
    RecyclerView.Adapter<LiveDeliveryAdapter.HomeViewHolder>() {
    private var data: List<DataModel> = ArrayList<DataModel>()
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        val theView: View = LayoutInflater.from(context).inflate(R.layout.my_live_delivery_list_item, parent, false)
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        ...
        holder.parent.setOnClickListener {
            communicatorFragmentInterface.addContentFragment(LiveParcelDetailsFragment(), true)
        }
    }
